...
-- Generated at: 2026-08-22T04:59:41.325Z
...
INSERT OR IGNORE INTO "users" ("id", "uid", "email", "display_name", "nickname", "photo_url", "password_hash", "real_balance", "demo_balance", "currency", "tfa_enabled", "tfa_mode", "tfa_secret", "is_verified", "is_email_verified", "is_nid_verified", "nid_number", "is_admin", "phone", "country", "country_code", "first_name", "last_name", "gender", "dob", "status", "kyc_status", "referred_by_uid", "referral_code", "referral_sub_id", "referral_type", "affiliate_balance", "total_affiliate_earnings", "referral_count", "custom_affiliate_share", "withdrawal_otp", "withdrawal_otp_expires_at", "total_live_volume", "updated_at", "created_at", "smart_mode_enabled", "smart_mode_strategy", "manipulation_mode") VALUES (1, 'admin_seed_56fqiu8q', 'hamproosapport@gmail.com', 'Bivaax Super Admin', 'Admin', NULL, '$2b$10$oGGEbJGJiDGiZCaCC.w9vOrWDiWnxVY/COcnsHQT83p6a65wS6wdG', 1000, 10000, 'USD', 0, 'app', NULL, 1, 0, 0, NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Standard', 'unverified', NULL, '1GJAEJ', NULL, NULL, 0, 0, 0, NULL, NULL, NULL, 0, NULL, 1787369230917, 0, 'auto_25_percent', 'neutral');
...
-- Dumping data for table trades (4 rows)
...
INSERT OR IGNORE INTO "trades" ("id", "firebase_id", "user_id", "market_id", "asset", "amount", "direction", "type", "entry_price", "exit_price", "duration", "time_left", "expiry_time", "expiration_time", "is_demo", "account_type", "tournament_id", "status", "payout_amount", "payout", "settled_at", "updated_at", "created_at") VALUES (4, '3', 'P0H1JYBZHJWlquOQ4yyfdjSy3Kc2', 'AUD/USD (OTC)', NULL, 1, 'down', NULL, 0.6196505716530748, 0.6175, 61, NULL, 1787372519, NULL, 1, 'demo', NULL, 'won', 1.9, NULL, 1787372519, NULL, 1787372458938);
...
-- Dumping data for table system_backups (16 rows)
...
INSERT OR IGNORE INTO "system_backups" ("id", "timestamp", "filename", "size", "status", "tables_count", "created_by") VALUES ('bk_1787372671221', 1787372671221, 'backup_2026-08-22T04-24-31-221Z_1787372671221.sql', 12072, 'success', 20, 'system_pre_boot');
INSERT OR IGNORE INTO "system_backups" ("id", "timestamp", "filename", "size", "status", "tables_count", "created_by") VALUES ('bk_fail_1787372671221', 1787372671221, 'N/A', 0, 'failed', 0, 'system_pre_boot');
INSERT OR IGNORE INTO "system_backups" ("id", "timestamp", "filename", "size", "status", "tables_count", "created_by") VALUES ('bk_1787373456462', 1787373456462, 'backup_2026-08-22T04-37-36-462Z_1787373456462.sql', 12536, 'success', 20, 'system_pre_boot');
INSERT OR IGNORE INTO "system_backups" ("id", "timestamp", "filename", "size", "status", "tables_count", "created_by") VALUES ('bk_fail_1787373456462', 1787373456462, 'N/A', 0, 'failed', 0, 'system_pre_boot');
