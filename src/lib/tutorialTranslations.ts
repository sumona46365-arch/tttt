export const tutorialTranslations: Record<string, any> = {
  ...
  bn: {
    ...
    p1: "কপি ট্রেডিং (Copy Trading) হলো এমন একটি আধুনিক বিনিয়োগ পদ্ধতি, যেখানে আপনি অভিজ্ঞ ট্রেডারদের ট্রেডিং কৌশল সরাসরি নিজের অ্যাকাউন্টে অনুসরণ করতে পারেন। আপনি যখন কোনো অভিজ্ঞ ট্রেডারের কার্যক্রম কপি করবেন, তখন সেই ট্রেডারের প্রতিটি ট্রেড আপনার অ্যাকাউন্টেও স্বয়ংক্রিয়ভাবে কার্যকর হবে। এটি নতুন ট্রেডারদের জন্য ট্রেডিং শেখার এবং বাজারের জটিলতা না বুঝেই বিনিয়োগ শুরু করার একটি দারুণ উপায়।",
    h1: "কেন কপি ট্রেডিং বেছে নেবেন?",
    l1_1: "সময় বাঁচায়: আপনাকে সারাদিন চার্টের সামনে বসে থাকার প্রয়োজন নেই। অভিজ্ঞ ট্রেডাররা আপনার হয়ে ট্রেড করবে।",
    l1_2: "ট্রেডিং দক্ষতা বাড়ায়: অভিজ্ঞদের কৌশল দেখে আপনি সহজেই ট্রেডিংয়ের খুঁটিনাটি বুঝতে পারবেন।",
    l1_3: "ঝুঁকি ব্যবস্থাপনা: নিজের পছন্দমতো ট্রেডার নির্বাচন করে ঝুঁকি নিয়ন্ত্রণ করা সম্ভব।",
    l1_4: "স্বয়ংক্রিয় ট্রেডিং: ট্রেড ওপেন করা বা ক্লোজ করার ঝামেলা নেই, সবকিছুই অটোমেটেড।",
    h2: "কপি ট্রেডিংয়ের ঝুঁকি ও সতর্কতা",
    p2: "কপি ট্রেডিং লাভজনক হলেও এতে ঝুঁকির সম্ভাবনা থাকে। মনে রাখবেন:",
    l2_1: "বাজারের ঝুঁকি: ট্রেডিংয়ে সবসময় লসের ঝুঁকি থাকে, এমনকি অভিজ্ঞদেরও লস হতে পারে।",
    l2_2: "সঠিক ট্রেডার নির্বাচন: শুধুমাত্র অতীত পারফরম্যান্স নয়, বরং ট্রেডারের ঝুঁকির ধরন বুঝে বিনিয়োগ করুন।",
    ...
    l3_4: "বিনিয়োগের পরিমাণ নির্ধারণ করুন এবং অটো-কপি চালু করুন।"
  }
};
