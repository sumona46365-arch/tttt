...
const NagadDeposit: React.FC = () => {
  ...
  const t = {
    BN: {
      ...
      step1Desc: appConfig.nagad_step1_en || `Send money via Nagad App or Cash-out menu to the number below.`,
      ...
      guideTitle: `Nagad Manual Deposit Guide`,
      guide: appConfig.nagad_guide_en ? appConfig.nagad_guide_en.split('\n') : [
        ...
        "3. Enter the Nagad number provided above.",
