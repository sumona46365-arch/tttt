...
const RocketDeposit: React.FC = () => {
  ...
  const t = {
    BN: {
      ...
      step1Desc: appConfig.rocket_step1_en || `Send money via Rocket App or Cash-out menu to the number below.`,
      ...
      guideTitle: `Rocket Manual Deposit Guide`,
      guide: appConfig.rocket_guide_en ? appConfig.rocket_guide_en.split('\n') : [
        ...
        "3. Enter the Rocket number provided above.",
